<?php
/**
 * Title: Template page left sidebar
 * Slug: frontis/template-page-left-sidebar
 * Categories: pages
...
?>
<!-- wp:group {"metadata":{"name":"page with left sidebar"},"style":{"spacing":{"padding":{"right":"var:preset|spacing|spacing-32","left":"var:preset|spacing|spacing-32","top":"var:preset|spacing|spacing-64","bottom":"var:preset|spacing|spacing-120"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--spacing-64);padding-right:var(--wp--preset--spacing--spacing-32);padding-bottom:var(--wp--preset--spacing--spacing-120);padding-left:var(--wp--preset--spacing--spacing-32)"><!-- wp:group {"align":"wide","layout":{"type":"constrained"}} -->
...
<!-- wp:column {"width":"66.66%","style":{"spacing":{"padding":{"right":"0px","left":"0px"}}}} -->
