<?php
/**
 * Title: Header Bright Turquoise
 * Slug: frontis/header-bright-turquoise
 * Categories: header
 */
...
$home_url =  home_url();
?>
<!-- wp:group {"metadata":{"name":"Header Bright Turquoise","categories":["header"],"patternName":"frontis/header-bright-turquoise"},"align":"wide","style":{"spacing":{"blockGap":"0","padding":{"right":"var:preset|spacing|spacing-32","left":"var:preset|spacing|spacing-32"}}},"layout":{"type":"default"}} -->
