<?php
/**
 * Title: Footer Conifer
 * Slug: frontis/footer-conifer
 * Categories: footer
 */
...
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"#f6fded"}}},"typography":{"fontSize":"18px","fontStyle":"normal","fontWeight":"400"},"spacing":{"margin":{"top":"var:preset|spacing|spacing-16","right":"0","bottom":"var:preset|spacing|spacing-24","left":"0"}},"color":{"text":"#f6fded"}}} -->
<p class="has-text-color has-link-color" style="color:#f6fded;margin-top:var(--wp--preset--spacing--spacing-16);margin-right:0;margin-bottom:var(--wp--preset--spacing--spacing-24);margin-left:0;font-size:18px;font-style:normal;font-weight:400">We’re a diverse and passionate team that takes ownership of your design and empower you.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:heading {"level":4,"align":"wide","style":{"elements":{"link":{"color":{"text":"#ffffff"}}},"typography":{"fontStyle":"normal","fontWeight":"600"},"spacing":{"padding":{"bottom":"var:preset|spacing|spacing-16"}},"color":{"text":"#ffffff"}},"fontSize":"h6"} -->
<h4 class="wp-block-heading alignwide has-text-color has-link-color has-h-6-font-size" style="color:#ffffff;padding-bottom:var(--wp--preset--spacing--spacing-16);font-style:normal;font-weight:600">Information</h4>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:navigation {"customTextColor":"#f6fded","overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|spacing-16"}},"fontSize":"p-1","layout":{"type":"flex","orientation":"vertical"}} -->
...
<div class="wp-block-column is-vertically-aligned-top" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:group {"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"margin":{"top":"0","bottom":"0"},"blockGap":"0"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:heading {"level":4,"align":"wide","style":{"elements":{"link":{"color":{"text":"#ffffff"}}},"typography":{"fontStyle":"normal","fontWeight":"600"},"spacing":{"padding":{"bottom":"var:preset|spacing|spacing-16"}},"color":{"text":"#ffffff"}},"fontSize":"h6"} -->
<h4 class="wp-block-heading alignwide has-text-color has-link-color has-h-6-font-size" style="color:#ffffff;padding-bottom:var(--wp--preset--spacing--spacing-16);font-style:normal;font-weight:600">Company</h4>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:navigation {"customTextColor":"#f6fded","overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|spacing-16"}},"layout":{"type":"flex","orientation":"vertical"}} -->
...
<div class="wp-block-column is-vertically-aligned-top" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;flex-basis:350px"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|spacing-24","bottom":"var:preset|spacing|spacing-24","left":"var:preset|spacing|spacing-24","right":"var:preset|spacing|spacing-24"}},"border":{"radius":"15px"},"color":{"background":"#476d0d"}},"layout":{"type":"constrained","justifyContent":"center","contentSize":""}} -->
<div class="wp-block-group has-background" style="border-radius:15px;background-color:#476d0d;padding-top:var(--wp--preset--spacing--spacing-24);padding-right:var(--wp--preset--spacing--spacing-24);padding-bottom:var(--wp--preset--spacing--spacing-24);padding-left:var(--wp--preset--spacing--spacing-24)"><!-- wp:heading {"level":4,"style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"spacing":{"margin":{"bottom":"var:preset|spacing|spacing-16"}}},"textColor":"white","fontSize":"h6"} -->
...
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"#f6fded"}}},"typography":{"fontStyle":"normal","fontWeight":"400"},"spacing":{"margin":{"top":"var:preset|spacing|spacing-16","right":"0","bottom":"0","left":"0"}},"color":{"text":"#f6fded"}},"fontSize":"p-1"} -->
<p class="has-text-color has-link-color has-p-1-font-size" style="color:#f6fded;margin-top:var(--wp--preset--spacing--spacing-16);margin-right:0;margin-bottom:0;margin-left:0;font-style:normal;font-weight:400">Hello, we are Justwp. Our goal is to translate the positive effects from revolutionizing how companies engage with their clients</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->

<!-- wp:separator {"align":"wide","className":"is-style-wide","style":{"spacing":{"margin":{"top":"var:preset|spacing|spacing-104","bottom":"var:preset|spacing|spacing-32"}},"color":{"background":"#233707"}}} -->
<hr class="wp-block-separator alignwide has-text-color has-alpha-channel-opacity has-background is-style-wide" style="margin-top:var(--wp--preset--spacing--spacing-104);margin-bottom:var(--wp--preset--spacing--spacing-32);background-color:#233707;color:#233707"/>
<!-- /wp:separator -->
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"#f6fded"}}},"color":{"text":"#f6fded"}},"fontSize":"p-1"} -->
<p class="has-text-color has-link-color has-p-1-font-size" style="color:#f6fded"><?php echo sprintf(esc_html__('Copyright @ %1$s - WordPress Theme by %2$s', 'frontis'), esc_html($current_year), '<a href="' . esc_url($theme_author_link) . '">' . esc_html($theme_author_name) . '</a>'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:navigation {"customTextColor":"#f6fded","overlayMenu":"never","style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"p-2","layout":{"type":"flex","justifyContent":"right"}} -->
