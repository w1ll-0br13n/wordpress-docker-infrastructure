<?php
/**
 * Title: Template single left sidebar
 * Slug: frontis/template-single-left-sidebar
 * Categories: pages
 * Keywords: single left sidebar, post left sidebar
 */
...
<figure class="wp-block-image size-full" style="margin-right:var(--wp--preset--spacing--spacing-8)"><img src="<?php echo esc_url($images[6]); ?>" alt="" class="wp-image-190" style="object-fit:cover"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full service-button-icon" style="margin-right:var(--wp--preset--spacing--spacing-8)"><img src="<?php echo esc_url($images[7]); ?>" alt="clock" class="wp-image-190"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:0"><!-- wp:image {"id":190,"sizeSlug":"full","linkDestination":"none","className":"service-button-icon","style":{"color":{"duotone":"var:preset|duotone|primary"},"spacing":{"margin":{"right":"var:preset|spacing|spacing-8"}}}} -->
<figure class="wp-block-image size-full service-button-icon" style="margin-right:var(--wp--preset--spacing--spacing-8)"><img src="<?php echo esc_url($images[8]); ?>" alt="storage" class="wp-image-190"/></figure>
<!-- /wp:image -->
...
<!-- wp:group {"style":{"spacing":{"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|8"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group" style="margin-top:0;margin-bottom:0"><!-- wp:image {"id":190,"sizeSlug":"full","linkDestination":"none","className":"service-button-icon","style":{"color":{"duotone":"var:preset|duotone|primary"},"spacing":{"margin":{"right":"var:preset|spacing|spacing-8"}}}} -->
<figure class="wp-block-image size-full service-button-icon" style="margin-right:var(--wp--preset--spacing--spacing-8)"><img src="<?php echo esc_url($images[9]); ?>" alt="chat" class="wp-image-190"/></figure>
<!-- /wp:image -->
