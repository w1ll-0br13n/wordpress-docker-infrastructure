jQuery(document).ready(function($) {
    'use strict';
    var this_obj = web_agency_elementor_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.web-agency-elementor-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message web-agency-elementor-plugin-install');
                button.addClass('button-primary web-agency-elementor-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.web-agency-elementor-recommended-plugins .web-agency-elementor-activation-note').css('display','block');
    ...
    $(document).on('click', '.web-agency-elementor-plugin-activate', function(event) {
