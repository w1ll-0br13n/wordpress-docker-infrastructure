...
function pure_portfolio_intro_text( $default_text ) {
	$default_text .= sprintf(
		'<div class="notice notice-info pure-portfolio-demo-data"><p class="demo-file-content">%1$s <a href="%2$s" target="_blank">%3$s</a></p></div>',
		esc_html__( 'Demo content files for Pure Portfolio Theme.', 'pure-portfolio' ),
		esc_url( 'https://docs.ascendoor.com/docs/pure-portfolio/getting-started/import-demo-content/' ),
