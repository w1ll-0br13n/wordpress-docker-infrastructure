<?php
$sunbrake_theme_svg_icons = array(
	'fort-awesome'         => array(
...
$sunbrake_theme_divider_style = array(
...
$defaults = array(
	...
	'icons'                             => $sunbrake_theme_svg_icons,
	'divider_style'                     => $sunbrake_theme_divider_style,
	'gradients'                         => $sunbrake_gradients,

	'assets_js_key'                     => 'kubioFrontendData',

	'edit_this_text_in_customizer'      => $sunbrake_title,
	'lorem_ipsum'                       => $sunbrake_subtitle,
	...
	'front-header'                      => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $sunbrake_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $sunbrake_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title' => array(
			'show'       => true,
			'value'      => $sunbrake_title,
			'localProps' => array(
				'content' => $sunbrake_title
			),
			'style'      => array(
				'descendants' => array(
					'text' => array(
		...
		'subtitle' => array(
			'show'       => true,
			'value'      => $sunbrake_subtitle,
			'localProps' => array(
				'content' => $sunbrake_subtitle
			),
			'style'      => array(
				'descendants' => array(
					'text' => array(
							...
							'image'     => array(
								array(
									'source'     => array(
										...
										'gradient' => $sunbrake_gradients['night_fade'],
									),
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $sunbrake_theme_svg_icons['facebook-square-full'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $sunbrake_theme_svg_icons['twitter-x'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $sunbrake_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $sunbrake_theme_svg_icons['vimeo'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $sunbrake_theme_svg_icons['map-marker'],
						'text'       => '123, Main Street, City, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $sunbrake_theme_svg_icons['phone'],
						'text'       => '+1 234 567 890',
						'link_value' => 'tel:+1 234 567 890',
						'index'      => 0,
					),
					array(
						'icon'       => $sunbrake_theme_svg_icons['envelope'],
	...
	'header'                            => array(
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					...
					array(
						'icon'       => $sunbrake_theme_svg_icons['whatsapp-square'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $sunbrake_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $sunbrake_theme_svg_icons['phone-square'],
