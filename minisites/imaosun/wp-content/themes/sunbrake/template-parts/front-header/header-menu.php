...
<div class="wp-block wp-block-kubio-dropdown-menu  position-relative wp-block-kubio-dropdown-menu__outer sunbrake-front-header__k__c6BbujDIAOY-outer sunbrake-local-563-outer kubio-dropdown-menu h-ignore-global-body-typography <?php echo $component->printHeaderMenuClasses(); ?>" data-kubio="kubio/dropdown-menu" data-kubio-component="dropdown-menu" data-kubio-settings="[]">
  ...
  'wrapper_class' => 'wp-block wp-block-kubio-logo position-relative wp-block-kubio-logo__container  kubio-logo-direction-row sunbrake-front-header__k__0xSC3AT64-container sunbrake-local--container',
  'logo_image_class' => 'position-relative wp-block-kubio-logo__image  kubio-logo-image  sunbrake-front-header__k__0xSC3AT64-image sunbrake-local--image',
  'alt_logo_image_class' => 'position-relative wp-block-kubio-logo__alternateImage kubio-logo-image kubio-alternate-logo-image   sunbrake-front-header__k__0xSC3AT64-alternateImage sunbrake-local--alternateImage',
  'logo_text_class' => 'position-relative wp-block-kubio-logo__text  sunbrake-front-header__k__0xSC3AT64-text sunbrake-local--text',
)); ?>
										</div>
									</div>
								</div>
								...
								<div class="wp-block wp-block-kubio-column  position-relative wp-block-kubio-column__container sunbrake-front-header__k__7AuOkWajPWG-container sunbrake-local-573-container d-flex h-col-lg-auto h-col-md-auto h-col-auto" data-kubio="kubio/column">
									<div class="position-relative wp-block-kubio-column__inner sunbrake-front-header__k__7AuOkWajPWG-inner sunbrake-local-573-inner d-flex h-flex-basis h-px-lg-2 v-inner-lg-2 h-px-md-3 v-inner-md-2 h-px-3 v-inner-2">
										...
										<div class="position-relative wp-block-kubio-column__align sunbrake-front-header__k__7AuOkWajPWG-align sunbrake-local-573-align h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-center align-self-md-center align-self-center">
											<?php sunbrake_theme_print_footer_copyright(true); ?>
										</div>
									</div>
								</div>
							</div>
