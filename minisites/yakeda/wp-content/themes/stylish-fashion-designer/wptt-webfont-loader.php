...
if ( ! class_exists( 'Stylish_Fashion_Designer_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Stylish_Fashion_Designer_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Stylish_Fashion_Designer_WPTT_WebFont_Loader( $url );
