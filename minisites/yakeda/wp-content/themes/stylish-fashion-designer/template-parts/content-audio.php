...
<?php
  ...
  $stylish_fashion_designer_audio = false;

  // Only get audio from the content if a playlist isn't present.
  if ( false === strpos( $stylish_fashion_designer_content, 'wp-playlist-script' ) ) {
    $stylish_fashion_designer_audio = get_media_embedded_in_content( $stylish_fashion_designer_content, array( 'audio' ) );
  }
?>
  ...
  <div class="box-image">
    <?php
      if ( ! is_single() ) {
        ...
        if ( ! empty( $stylish_fashion_designer_audio ) ) {
          foreach ( $stylish_fashion_designer_audio as $stylish_fashion_designer_audio_html ) {
            echo '<div class="entry-audio">';
              echo $stylish_fashion_designer_audio_html;
